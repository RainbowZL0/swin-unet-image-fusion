...
class MyTraining:
    ...
    def start_train(self):
        ...
        print(
            Fore.CYAN + f"Starting at epoch = {self.current_epochs}, "
    ...
    def calcu_current_total_iters(self):
        return (self.current_epochs - 1) * len(self.tr_dtl) + self.current_iters_in_one_epoch
    ...
    def save_vali_result(self, ir: Tensor, vis: Tensor, fusion: Tensor):
        ...
        time_str = get_time_str()
        saved_image_name = (
            f"{time_str}_Epoch{self.current_epochs}_EpIters{self.current_iters_in_one_epoch}_TotalIters{self.current_total_iters}.png"
        )
    ...
    def load_my_state(self):
        ...
        print(Fore.CYAN + "State is loaded successfully.")
    ...
    def del_params_in_model_state_and_optim_state_by_name(
        ...
        for param_name in param_name_list:
            ...
            # 从optimizer状态中删除
            params_id_list = []
            for i, (name, _param) in enumerate(self.model.named_parameters()):
                if name == param_name:
