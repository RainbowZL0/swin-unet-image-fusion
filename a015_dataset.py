...
class MyDataset(Dataset):
    ...
    def get_ir_vis_paths(self) -> tuple[list, list]:
        ...
        ir_path_list = []
        vis_path_list = []
        for root, _dirs, files in os.walk(self.dataset_folder):
    ...
    def get_compose_stage_1(self):
        ...
        if not self.is_test:
            transform_list += [v2.RandomResizedCrop(size=(224, 224)), v2.RandomHorizontalFlip(p=0.5)]
    ...
    def __getitem__(self, index) -> dict:
        ...
        ir, vis = (
            cv2.imread(filename=ir_path, flags=cv2.IMREAD_GRAYSCALE),
